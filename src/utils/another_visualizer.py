...
# Ahmet: This is based on the original RoadTestVisualizer, but doesn't directly show the figure
# It is used in the road_points_gui.py

class RoadTestVisualizerForGUI:
    """
    ...
    def __init__(self, map_size):
        ...
        # GUI version: Don't directly show the figure
        # plt.ion()
        # plt.show()
    ...
    def visualize_road_test(self, the_test):
        ...
        # GUI version: Don't show the figure
        # plt.draw()
        # plt.pause(0.001)
